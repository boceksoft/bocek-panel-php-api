...
final class HomesManagementDetailDataController extends Controller
{
    ...
    private function fields(): array
    {
        return [
            ...
            $this->field('hasarDepozitosu', 'number'),
            ...
            $this->field('ribbon', 'string'),
            $this->field('ribbon2', 'string'),
    ...
    private function selectedValues(array $row, array $sites): array
    {
        ...
        return [
            ...
            'n_bolge' => (int) ($row['n_emlak_bolgesi'] ?? 0),
            'n_emlak_bolgesi' => (int) ($row['n_emlak_bolgesi'] ?? 0),
